...
from qwen_image_cli.core.output import print_error, print_json, print_success, print_task_result
...
def tasks_batch(
    ...
    Examples:
      ...
      qwen_image tasks abc123 def456 ghi789
    """
    client = get_client(ctx.obj.get("token"))
    try:
...
def wait(
    ...
    Examples:
      ...
      qwen_image wait abc123

      qwen_image wait abc123 --interval 10 --timeout 300
    """
    client = get_client(ctx.obj.get("token"))
    elapsed = 0
