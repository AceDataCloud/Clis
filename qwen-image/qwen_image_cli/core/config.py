"""Configuration management for QwenImage CLI."""
...
class Settings:
    ...
    request_timeout: float = field(
        default_factory=lambda: float(os.environ.get("QWEN_IMAGE_REQUEST_TIMEOUT", "1800"))
    )
    default_model: str = field(
        default_factory=lambda: os.environ.get("QWEN_IMAGE_DEFAULT_MODEL", "qwen-image-3.0")
    )
