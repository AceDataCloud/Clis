...
def test_settings_default_values():
    ...
    assert settings.default_model == "qwen-image-3.0"


def test_settings_from_environment():
    os.environ["ACEDATACLOUD_API_TOKEN"] = "test-token-123"
    os.environ["ACEDATACLOUD_API_BASE_URL"] = "https://custom.api.example.com"
    os.environ["QWEN_IMAGE_REQUEST_TIMEOUT"] = "300"
    os.environ["QWEN_IMAGE_DEFAULT_MODEL"] = "qwen-image-3.0-pro"
    ...
    try:
        ...
        assert settings.default_model == "qwen-image-3.0-pro"
    finally:
        del os.environ["ACEDATACLOUD_API_TOKEN"]
        del os.environ["ACEDATACLOUD_API_BASE_URL"]
        del os.environ["QWEN_IMAGE_REQUEST_TIMEOUT"]
        del os.environ["QWEN_IMAGE_DEFAULT_MODEL"]
