"""Configuration management for Fish CLI."""
...
class Settings:
    ...
    request_timeout: float = field(
        default_factory=lambda: float(os.environ.get("FISH_REQUEST_TIMEOUT", "300"))
    )
    default_model: str = field(
        default_factory=lambda: os.environ.get("FISH_DEFAULT_MODEL", "s2-pro")
    )
