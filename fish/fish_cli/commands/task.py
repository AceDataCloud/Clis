...
from fish_cli.core.output import print_error, print_json, print_success, print_task_result
...
def task(
    ...
    TASK_ID is the task ID returned from async commands (e.g. fish tts --callback-url ...).
...
def wait(
    ...
    Examples:
      ...
      fish wait abc123 --interval 10 --timeout 120
    """
    client = get_client(ctx.obj.get("token"))
    elapsed = 0
