...
@click.option("--audio-file", default=None, help="Audio file content for audio2video mode.")
...
@click.option("--voice-speed", default=None, type=float, help="Voice speed for text2video mode.")
