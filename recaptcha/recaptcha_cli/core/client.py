...
class RecaptchaClient:
    ...
    def recognize2(self, **kwargs: Any) -> dict[str, Any]:
        """Recognize reCAPTCHA v2 using /captcha/recognition/recaptcha2."""
        return self.request("/captcha/recognition/recaptcha2", kwargs)

    def token2(self, **kwargs: Any) -> dict[str, Any]:
        """Get reCAPTCHA v2 token using /captcha/token/recaptcha2."""
        return self.request("/captcha/token/recaptcha2", kwargs)

    def token3(self, **kwargs: Any) -> dict[str, Any]:
        """Get reCAPTCHA v3 token using /captcha/token/recaptcha3."""
