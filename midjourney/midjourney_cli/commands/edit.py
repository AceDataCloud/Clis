...
def shorten(
    ...
    """Shorten a long Midjourney prompt into concise alternatives.

    PROMPT is the long prompt to shorten.

    \b
    Examples:
      midjourney shorten "A very detailed and elaborate description of a majestic mountain"
      midjourney shorten "Long prompt here" --json
    """
    client = get_client(ctx.obj.get("token"))
    try:
