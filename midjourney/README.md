...
- **Image Editing** — Edit with prompts and masks, describe images (reverse prompt), translate and shorten prompts
...
| `midjourney shorten <prompt>` | Analyze and return shortened prompt candidates |
