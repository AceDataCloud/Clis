...
- **Image Editing** — Edit with prompts and masks, describe images (reverse prompt), shorten and translate prompts
...
| `midjourney shorten <prompt>` | Analyze and shorten a prompt into up to 5 candidates |
...
│       ├── edit.py        # Edit, describe, shorten, translate commands
