...
| `suno persona-list --user-id <user_id>` | List saved personas for a user |
| `suno persona-delete <persona_id>` | Delete a saved persona |
| `suno voices <audio_url>` | Create a custom voice persona from audio |
