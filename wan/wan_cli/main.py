#!/usr/bin/env python3
"""
Wan CLI - Tongyi Wansiang AI Video Generation via AceDataCloud API.
...
from wan_cli.commands.info import config, models, resolutions, shot_types
from wan_cli.commands.task import task, tasks_batch, wait
from wan_cli.commands.video import generate, image_to_video, reference_to_video
...
def cli(ctx: click.Context, token: str | None) -> None:
    """Wan CLI - Tongyi Wansiang AI Video Generation powered by AceDataCloud.
