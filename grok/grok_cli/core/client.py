...
class GrokClient:
    """HTTP client for AceDataCloud Grok API."""
    ...
    def generate_video(self, **kwargs: Any) -> dict[str, Any]:
        """Generate a video using the Grok API."""
        return self.request("/grok/videos", kwargs)

    def query_task(self, **kwargs: Any) -> dict[str, Any]:
        """Query task status using the tasks endpoint."""
        return self.request("/grok/tasks", kwargs)
