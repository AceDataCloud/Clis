...
from grok_cli.commands._json import (
    parse_json_array,
    parse_json_object,
...
@click.option(
    "-m",
    "--model",
    type=click.Choice(GROK_CHAT_MODELS),
    default=DEFAULT_CHAT_MODEL,
    show_default=True,
    help="Grok model to use for chat completion.",
)
@click.option(
    "-s",
    "--system",
...
def chat(
    ...
    Examples:
      ...
      grok chat "Explain quantum computing" -m grok-3
      grok chat "Write a poem" --temperature 0.9
      grok chat "Summarize this" -s "You are a concise summarizer"
    """
