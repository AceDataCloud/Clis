...
from deepseek_cli.core.client import get_client
from deepseek_cli.core.exceptions import DeepSeekError
from deepseek_cli.core.output import (
    DEFAULT_MODEL,
    MODELS,
    print_chat_result,
    print_error,
...
def chat(
    ...
    Examples:
      ...
      deepseek-cli chat "Write a poem" --temperature 0.9
      deepseek-cli chat "Summarize this" -s "You are a concise summarizer"
    """
