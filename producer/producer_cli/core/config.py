"""Configuration management for Producer CLI."""
...
class Settings:
    ...
    request_timeout: float = field(
        default_factory=lambda: float(os.environ.get("PRODUCER_REQUEST_TIMEOUT", "1800"))
    )
    default_model: str = field(
        default_factory=lambda: os.environ.get("PRODUCER_DEFAULT_MODEL", "FUZZ-2.0")
    )
