...
def test_settings_from_environment():
    ...
    os.environ["PRODUCER_REQUEST_TIMEOUT"] = "300"
    os.environ["PRODUCER_DEFAULT_MODEL"] = "FUZZ-2.0 Pro"
    ...
    try:
        ...
        del os.environ["PRODUCER_REQUEST_TIMEOUT"]
        del os.environ["PRODUCER_DEFAULT_MODEL"]
