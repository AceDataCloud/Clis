"""Pytest configuration and fixtures for Turnstile CLI tests."""
...
def mock_token_response():
    """Mock successful Turnstile token response."""
    return {
        "token": "0.zScW-EiocHwwpwqtk1QXlJnGnU.test-token",
        "elapsed": 12.4,
    }
...
def mock_token_async_response():
    """Mock async Turnstile token submission response."""
    return {
